...
# date: 05.05.2022
# last modified:25.04.2024 (Roel)

root_dir="/project/4180000.23/MRI_data"
og_bids="bids"
RABIES="/opt/rabies/0.4.8/rabies.sif"


#arguments for RABIES preprocessing, confound regression, analysis
prep_arg='--TR 1 --commonspace_reg masking=false,brain_extraction=false,template_registration=SyN,fast_commonspace=true --commonspace_resampling 0.3x0.3x0.3 --anat_inho_cor method=N4_reg,otsu_thresh=2,multiotsu=false --bold_inho_cor method=N4_reg,otsu_thresh=2,multiotsu=false' 
conf_arg='--TR 1 --highpass 0.01 --smoothing_filter 0.5 --lowpass 0.1 --conf_list global_signal mot_6'
analysis_arg='--prior_maps /project/4180000.23/fMRI_Wessel/DR_5HT/Smoothed_maps/5HTR_exp_zscored_merged_smooth08.nii.gz --DR_ICA --group_ica apply=true,dim=10,random_seed=1'
...
do
  ...
  qsub -l 'walltime=36:00:00,mem=12gb,procs=2' $file
